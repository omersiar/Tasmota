...
be_local_class(Matter_Device,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        { be_const_key_weak(z_light0, -1), be_const_class(be_class_Matter_Plugin_Zigbee_Light0) },
        { be_const_key_weak(v_airquality, -1), be_const_class(be_class_Matter_Plugin_Virt_Sensor_Air_Quality) },
        { be_const_key_weak(http_occupancy, 24), be_const_class(be_class_Matter_Plugin_Bridge_Sensor_Occupancy) },
        { be_const_key_weak(http_relay, -1), be_const_class(be_class_Matter_Plugin_Bridge_OnOff) },
        { be_const_key_weak(http_flow, 49), be_const_class(be_class_Matter_Plugin_Bridge_Sensor_Flow) },
        { be_const_key_weak(v_rain, -1), be_const_class(be_class_Matter_Plugin_Virt_Sensor_Rain) },
        { be_const_key_weak(http_airquality, 51), be_const_class(be_class_Matter_Plugin_Bridge_Sensor_Air_Quality) },
        { be_const_key_weak(http_humidity, -1), be_const_class(be_class_Matter_Plugin_Bridge_Sensor_Humidity) },
        { be_const_key_weak(pressure, 14), be_const_class(be_class_Matter_Plugin_Sensor_Pressure) },
        { be_const_key_weak(shutter_X2Btilt, 25), be_const_class(be_class_Matter_Plugin_ShutterTilt) },
        { be_const_key_weak(v_light3, 31), be_const_class(be_class_Matter_Plugin_Virt_Light3) },
        { be_const_key_weak(http_light1, -1), be_const_class(be_class_Matter_Plugin_Bridge_Light1) },
        { be_const_key_weak(http_pressure, 7), be_const_class(be_class_Matter_Plugin_Bridge_Sensor_Pressure) },
        ...
        { be_const_key_weak(http_light3, 6), be_const_class(be_class_Matter_Plugin_Bridge_Light3) },
        ...
        { be_const_key_weak(http_light2, 44), be_const_class(be_class_Matter_Plugin_Bridge_Light2) },
        ...
        { be_const_key_weak(light2, 46), be_const_class(be_class_Matter_Plugin_Light2) },
        { be_const_key_weak(fan, 39), be_const_class(be_class_Matter_Plugin_Fan) },
        { be_const_key_weak(z_humidity, -1), be_const_class(be_class_Matter_Plugin_Zigbee_Humidity) },
        { be_const_key_weak(aggregator, 41), be_const_class(be_class_Matter_Plugin_Aggregator) },
        ...
        { be_const_key_weak(thermostat, -1), be_const_class(be_class_Matter_Plugin_Thermostat) },
        ...
        { be_const_key_weak(z_light1, 58), be_const_class(be_class_Matter_Plugin_Zigbee_Light1) },
        { be_const_key_weak(v_contact, 4), be_const_class(be_class_Matter_Plugin_Virt_Sensor_Contact) },
        ...
        { be_const_key_weak(rain, 3), be_const_class(be_class_Matter_Plugin_Sensor_Rain) },
        ...
        { be_const_key_weak(v_light0, 37), be_const_class(be_class_Matter_Plugin_Virt_Light0) },
        ...
        { be_const_key_weak(z_light2, 32), be_const_class(be_class_Matter_Plugin_Zigbee_Light2) },
        { be_const_key_weak(v_flow, -1), be_const_class(be_class_Matter_Plugin_Virt_Sensor_Flow) },
        { be_const_key_weak(z_occupancy, -1), be_const_class(be_class_Matter_Plugin_Zigbee_Occupancy) },
